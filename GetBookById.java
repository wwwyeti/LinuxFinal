...
public class GetBookById extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://123.60.43.242/linux_final";
    static final String USER = "root";
    static final String PASS = "Yt180235!";
    static final String SQL_QURERY_BOOK_BY_ID = "SELECT * FROM Book WHERE id=?";
    static final String REDIS_URL = "123.60.43.242";
